...
| `product/AttachTeacherModal.tsx` | Привязка по коду (SYSOLA-PRO / KOMI-XXXXXX) |
...
- Преподаватель: **ник `daniil`, пароль `Pudov-Ege-2026`**, код ученикам **`SYSOLA-PRO`**.
...
`VITE_ADMIN_PASSWORD=Pudov-Ege-2026`, `VITE_ADMIN_TEACHER_CODE=SYSOLA-PRO`.
