...
/* ────────────────────────────────────────────────────────────────────
   Банк заданий по структуре ЕГЭ-2027 (обобщённый план ФИПИ).
   Часть 1: №1–13 (краткий ответ, автопроверка).
   Часть 2: №14–20 (развёрнутый ответ, ручная проверка).
   Всего 20 заданий; максимум 31 первичный балл
   (13×1 за часть 1 + 2+2+2+2+3+4+4 = 18 за часть 2).
   🆕 — новые темы/позиции в структуре 2027 года.
   ──────────────────────────────────────────────────────────────────── */
export const BANK: BankTopic[] = [
  { number: 1, topic: "Планиметрия", part: 1, success: 95, solved: 19, attempts: 20, trend: "up", note: "Треугольники, четырёхугольники, окружность; длины, углы, площади, подобие. Начните с прямоугольных треугольников." },
  { number: 2, topic: "Векторы", part: 1, success: 90, solved: 18, attempts: 20, trend: "up", note: "Координаты, сумма и разность, умножение на число, скалярное произведение, угол между векторами." },
  { number: 3, topic: "Стереометрия", part: 1, success: 85, solved: 17, attempts: 20, trend: "flat", note: "Пространственные фигуры, углы, расстояния, объёмы, площади; связь со стереометрией и планиметрией." },
  { number: 4, topic: "Вероятность — базовая", part: 1, success: 75, solved: 15, attempts: 20, trend: "flat", note: "Вероятность случайного события, простейшие классические задачи: P = m/n." },
  { number: 5, topic: "Вероятность — продвинутая", part: 1, success: 80, solved: 16, attempts: 20, trend: "up", note: "Сложение и умножение вероятностей, полная вероятность, комбинаторные методы." },
  { number: 6, topic: "Случайные величины и статистика 🆕", part: 1, success: 62, solved: 12, attempts: 19, trend: "down", note: "🆕 Распределения, матожидание, дисперсия, среднее квадратическое отклонение; равномерное, показательное, нормальное распределения." },
  { number: 7, topic: "Уравнения", part: 1, success: 60, solved: 12, attempts: 20, trend: "down", note: "Рациональные, иррациональные, показательные, логарифмические, тригонометрические уравнения и системы. Проверяйте ОДЗ." },
  { number: 8, topic: "Преобразование выражений", part: 1, success: 70, solved: 14, attempts: 20, trend: "flat", note: "Степени, корни, логарифмы, дробно-рациональные выражения, вычисления." },
  { number: 9, topic: "Начала матанализа", part: 1, success: 55, solved: 11, attempts: 20, trend: "down", note: "Производная, первообразная, касательная, экстремумы, наибольшее/наименьшее значение, площадь через интеграл." },
  { number: 10, topic: "Прикладная математика", part: 1, success: 48, solved: 10, attempts: 20, trend: "down", note: "Реальная ситуация → математическая модель; выражения, уравнения, неравенства; оценка правдоподобности." },
  { number: 11, topic: "Текстовые задачи", part: 1, success: 38, solved: 8, attempts: 20, trend: "down", note: "Движение, работа, проценты; составление уравнений и неравенств. Приём: таблица → уравнение → проверка." },
  { number: 12, topic: "Функции и графики", part: 1, success: 84, solved: 17, attempts: 20, trend: "up", note: "Формулы зависимостей, графики функций, использование графиков для решения уравнений." },
  { number: 13, topic: "Моделирование + экономика 🆕", part: 1, success: 66, solved: 13, attempts: 19, trend: "flat", note: "🆕 Практические текстовые задачи; личные и семейные финансы; финансовые модели; составление и исследование модели." },
  { number: 14, topic: "Уравнения", part: 2, success: 72, solved: 9, attempts: 12, trend: "up", note: "Сложные уравнения, системы; различные методы решения." },
  { number: 15, topic: "Стереометрия", part: 2, success: 64, solved: 7, attempts: 11, trend: "flat", note: "Многогранники и тела вращения, сечения, углы, расстояния, площади, объёмы; планиметрия внутри стереометрии." },
  { number: 16, topic: "Неравенства", part: 2, success: 45, solved: 4, attempts: 9, trend: "flat", note: "Решение сложных неравенств и систем; различные методы." },
  { number: 17, topic: "Математическое моделирование 🆕", part: 2, success: 40, solved: 3, attempts: 8, trend: "down", note: "🆕 Реальная ситуация → модель → уравнение/неравенство/система → исследование → решение → интерпретация." },
  { number: 18, topic: "Планиметрия", part: 2, success: 68, solved: 6, attempts: 9, trend: "up", note: "Треугольники, окружности, четырёхугольники; углы, длины, площади; доказательные рассуждения." },
  { number: 19, topic: "Параметры", part: 2, success: 30, solved: 2, attempts: 7, trend: "flat", note: "Уравнения/неравенства с параметром, системы, графические методы, исследование количества решений." },
  { number: 20, topic: "Теория чисел", part: 2, success: 52, solved: 4, attempts: 8, trend: "up", note: "Целые и натуральные числа, делимость, остатки, НОД/НОК, доказательства, контрпримеры." },
];
...
export const REAL_VARIANT: VariantTask[] = [
  ...
  { number: 12, category: "Функции и графики", part: 1, maxScore: 1, statement: String.raw`Найдите наибольшее значение функции \( y = \ln(x + 5)^5 - 5x \) на отрезке \( [-4{,}5;\ 0] \).`, hint: "Найдите производную и критические точки.", solution: "y′ = 5/(x+5) − 5 = 0 → x = −4. y(−4) = 0 — наибольшее.", answer: "0" },
