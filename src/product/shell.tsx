...
const TICKER_EVENTS = [
  "Анна, Ухта — 96 баллов за вариант «Основной 2023»",
  "Дмитрий занимается 18 дней подряд",
  "Мария, Печора — разобрала 5 ошибок в журнале",
  "Арсений решает 12 задач по теме «Параметры»",
  "Полина, Воркута: личный рекорд — 87 баллов",
  "Егор: 85% точности в тренажёре вероятностей",
  "Влада, Микунь присоединилась к платформе",
  "Никита, Инта — 80 баллов за вариант «Досрочный 2024»",
  "Кира занимается 14 дней подряд",
  "Тимофей, Эжва — решил №18 «Параметры» на 4 балла",
];
            ...
            <>
              <span className="hidden items-center gap-2.5 rounded-full border border-board-600/70 bg-board-800/60 py-1 pl-1 pr-3.5 sm:flex">
                ...
                <span className="text-left">
                  <span className="block text-[12px] font-bold leading-tight text-chalk-50">{user.name.split(" ")[0]}</span>
